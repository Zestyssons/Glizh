...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName('task')
            .setDescription('La tarea a añadir')
            .setRequired(true)
        )
        .addStringOption((option) =>
          option
            .setName('priority')
            .setDescription('Establece el nivel de prioridad: baja, media, alta')
            .setRequired(false)
            .addChoices(
              { name: 'Baja', value: 'low' },
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName('delete')
        .setDescription('Eliminar una tarea de tu lista.')
        .addIntegerOption((option) =>
          option
            .setName('task_number')
            .setDescription('El número de la tarea a eliminar')
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName('delete_all')
        .setDescription('Eliminar todas las tareas de tu lista.')
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName('complete')
